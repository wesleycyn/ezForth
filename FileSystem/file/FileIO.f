...
\ 操縱檔案的詞群
   ...
   : f$! (  buf_A buf_L L_Lo L_Hi Fname_A Fname_L --- ) 
	r/w 開檔 >r
      	r@  移動檔案指標 
      	r@ 寫檔
      	r> 關檔 
    ...
    : f$@ ( buf_A buf_L L_Lo L_Hi Fname_A Fname_L --- ReadLength ) 
      r/w 開檔 >r
      r@  移動檔案指標 
      r@ 讀檔
      r> 關檔
...
: demo 
        ...
        s" qkljdl;w" 0 s>d s" test2.bin" f$!  	\ write to file
	Temp$ 10 0 s>d  s" test2.bin" f$@       \ read to file
	Temp$ swap dump
      	; 
