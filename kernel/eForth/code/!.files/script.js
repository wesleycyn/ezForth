...
var ENDSHOW_MESG="放映結束，按一下即可離開。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=8, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0004.htm", 1, 1),
   new hrefList("slide0007.htm", 1, 2),
   new hrefList("slide0006.htm", 1, 3),
   new hrefList("slide0008.htm", 1, 4),
   new hrefList("slide0009.htm", 1, 5),
   new hrefList("slide0010.htm", 1, 6),
   new hrefList("slide0011.htm", 1, 7),
...
var sNext="下一個",sPrev="前一個",sEnd="結束放映",sFont="新細明體"
function ShowMenu()
{
	BuildMenu();
